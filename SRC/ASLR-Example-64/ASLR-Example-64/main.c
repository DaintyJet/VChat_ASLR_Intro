...
int main(int argc, char* argv[]) {
    ...
    __debugbreak();
#endif
/*  Inline ASM is not supported in 64-bit windows applications.
    Use DEbug Intrinsic https://learn.microsoft.com/en-us/cpp/intrinsics/debugbreak?view=msvc-170
...
*/
    ...
    *((char*)v_ptr) = "C";
    ...
    printf("\nSTACK DATA:\n");
    for (test, s_ptr = &test; test < STACK_NUM; test++, s_ptr = s_ptr + 2)
        printf("%-2d: %08p %08lx%08lx\n", test, (void*)s_ptr, *((int*)s_ptr  +1), *((int*)s_ptr));
