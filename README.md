...
> [!NOTE]
> The only bits that can be randomized in the 32-bit EXE are 8-bits relating to the directory page table entry and page table offset. Specifically, these are bits 16 - 23. This is because the Virtual Address is separated into various fields.
